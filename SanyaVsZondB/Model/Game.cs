    ...
    public class Game
    {
        ...
        public Game()
        {
            ...
            PlayerImprovements = new List<(Action action, string name)>
            {
                ...
                (action: new Action(() => { Data.Player.Weapon.IncreaseCountBulletsInQueue(1); }), name: "Увеличить кол-во пуль в очереди на 1"),
                (action: new Action(() => { Data.Player.Weapon.IncreaseDamage(1.2); }), name: "Увеличить урона на 20%"),
        ...
        public Map CreateSecondLevelMap() => new Map(1080, 1920, CreateLevel(10, 1, 1.5, 100, 20, Data));

        public Map CreateThirdLevelMap() => new Map(1080, 1920, CreateLevel(25, 1, 0.5, 100, 20, Data));

        public Map CreateFourthLevelMap() => new Map(1080, 1920, CreateLevel(50, 1, 1, 100, 20, Data));

        public Map CreateFifthLevelMap() => new Map(1080, 1920, CreateLevel(75, 1, 1, 100, 20, Data));
